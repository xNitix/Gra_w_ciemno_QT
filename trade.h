...
private:
    ...
    int target_value;
    bool is_offert_accepted(std::vector<int> letter_to_sell, int price_for_letters, int price, bool check_history=true);
    int trade_price;
...
public:
    ...
    bool player_offer(std::vector<int> letter_to_sell, int price_for_letters, bool check_history=true);
    ...
    void move_letters_to_player(std::vector<int> letter_give);
